...
// Define darker color arrays for candles, balloons, and confetti
const candleColors = ['#B22222', '#008B8B', '#104E8B', '#CD5C5C', '#3CB371']
const balloonColors = ['#B22222', '#008B8B', '#104E8B', '#CD5C5C', '#3CB371'] 
...
export default function BirthdayWish() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Birthday card with transparent background */}
        <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-0 bg-transparent">
          {/* Card header with birthday message */}
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-bold text-black">Happy 17th Birthday!</CardTitle>
            <CardDescription className="text-2xl font-semibold text-black">Aleeza</CardDescription>
            <p className="text-lg text-black">October 17th</p>
          </CardHeader>
          {/* Card content with candles and balloons */}
          <CardContent className="space-y-6 text-center">
            <div>
              <h3 className="text-lg font-semibold text-blue-950 mb-2">Light the candles:</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-blue-950 mb-2">Pop the balloons:</h3>
              <div className="flex justify-center space-x-2">
          ...
          <CardFooter className="flex justify-center">
            <Button
              className="bg-black text-white hover:bg-black transition-all duration-300"
              onClick={celebrate}
